...
arch-chroot $ROOTFS /bin/sh -c 'curl -sL raw.githubusercontent.com/ArchLinuxJP/docker-mkimage-arch/master/bin/docker-arch -o /usr/bin/docker-arch;chmod +x /usr/bin/docker-arch;export PATH=$PATH:/usr/bin'
